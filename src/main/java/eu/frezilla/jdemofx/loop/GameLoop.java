...
public final class GameLoop {
    ...
    public GameLoop(FrameRateEnum frameRate, Stage stage) {
        ...
        this.stage = new Stage() {
            @Override public void cleanUpAndExit() {}
            @Override public boolean continueLoop() { return false;}
            @Override public void initialize() {}
            @Override public Stage next() { return stage; }
            @Override public void processInput() {}
            @Override public void renderFrame() {}
            @Override public void updateGameState() {}
        };
    }
